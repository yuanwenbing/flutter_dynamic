 ...
 * {@link FlutterActivity} and
 * {@link FlutterFragment} use the {@code FlutterEngineCache} singleton
 * internally when instructed to use a cached {@link FlutterEngine} based on a given ID. See
 * {@link FlutterActivity.CachedEngineIntentBuilder} and
 * {@link FlutterFragment#withCachedEngine(String)} for related APIs.
 */
