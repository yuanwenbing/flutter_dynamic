 ...
 * until it completes, or until the {@link FlutterEngine} that owns
...
public class DartExecutor implements BinaryMessenger {
  ...
  private final BinaryMessageHandler isolateChannelMessageHandler =
  ...
  /**
   * Invoked when the {@link FlutterEngine} that owns this
   ...
   * ByteBuffer, BinaryReply)}, developers can optionally
  ...
  private static class DefaultBinaryMessenger implements BinaryMessenger {
    ...
    /**
     * Sets the given {@link BinaryMessageHandler} as the
