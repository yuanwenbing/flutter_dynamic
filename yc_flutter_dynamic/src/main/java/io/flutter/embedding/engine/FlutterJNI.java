 ...
 * more complicated with every additional Java class that contains JNI calls. ThirdActivity, most Android
 ...
 *
 * <ol>
 *   <li>{@link #addEngineLifecycleListener(FlutterEngine.EngineLifecycleListener)}</li>
...
public class FlutterJNI {
   ...
   * to paint.
   * <p>
   * See {@link SurfaceHolder.Callback#surfaceCreated(SurfaceHolder)} for an example
   ...
   * <p>
   * See {@link SurfaceHolder.Callback#surfaceChanged(SurfaceHolder, int, int, int)}
   ...
   * {@link #onSurfaceCreated(Surface)}.
   * <p>
   * See {@link SurfaceHolder.Callback#surfaceDestroyed(SurfaceHolder)} for an example
   * of where this call might originate.
   */
  @UiThread
   ...
   * events, e.g., {@link FlutterEngine.EngineLifecycleListener#onPreEngineRestart()}.
   */
  @UiThread
  ...
  private void onPreEngineRestart() {
    for (FlutterEngine.EngineLifecycleListener listener : engineLifecycleListeners) {
