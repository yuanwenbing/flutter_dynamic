...
public interface PluginRegistry {
  ...
  /**
   * Attaches the given {@code plugin} to the {@link FlutterEngine}
   * associated with this {@code PluginRegistry}.
   */
  void add(@NonNull FlutterPlugin plugin);

  /**
   * Attaches the given {@code plugins} to the {@link FlutterEngine}
   * associated with this {@code PluginRegistry}.
   */
   ...
   * {@link FlutterEngine} associated with this {@code PluginRegistry}.
   */
  ...
  /**
   * Detaches the plugin of the given type from the {@link FlutterEngine}
   * associated with this {@code PluginRegistry}.
   * <p>
  ...
  /**
   * Detaches the plugins of the given types from the {@link FlutterEngine}
   * associated with this {@code PluginRegistry}.
   * <p>
