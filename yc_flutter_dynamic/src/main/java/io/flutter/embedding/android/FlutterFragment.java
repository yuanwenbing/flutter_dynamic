 ...
 * {@link Activity#startActivityForResult(Intent, int)}. If the {@code Activity} version
...
public class FlutterFragment extends Fragment implements FlutterActivityAndFragmentDelegate.Host {
  ...
  public static class NewEngineFragmentBuilder {
     ...
     * receive {@code Activity}-specific calls, e.g., {@link Activity#onNewIntent(Intent)}.
  ...
  /**
   * A new Intent was received by the {@link Activity} that currently owns this
   * {@link Fragment}.
   * <p>
   ...
   * {@link ActivityControlSurface#attachToActivity(Activity, Lifecycle)}.
   * <p>
   * It is possible that the owning {@code FragmentActivity} opted not to connect itself as
   * an {@link ActivityControlSurface}. In that
