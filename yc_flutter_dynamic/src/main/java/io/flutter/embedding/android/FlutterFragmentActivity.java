...
public class FlutterFragmentActivity extends FragmentActivity
  ...
  public static class NewEngineIntentBuilder {
     ...
     * {@link FlutterActivityLaunchConfigs.BackgroundMode#opaque} or {@link FlutterActivityLaunchConfigs.BackgroundMode#transparent}.
     * <p>
     * The default background mode is {@link FlutterActivityLaunchConfigs.BackgroundMode#opaque}.
     * <p>
     * Choosing a background mode of {@link FlutterActivityLaunchConfigs.BackgroundMode#transparent} will configure the inner
     ...
     * {@link FlutterActivityLaunchConfigs.BackgroundMode#transparent} must have a theme applied to it that includes the
   ...
   * to launch a {@code FlutterFragmentActivity} that internally uses an existing
   ...
   * existing {@link FlutterEngine} that is cached in
   * {@link FlutterEngineCache}.
   */
   ...
   *   <li>In the AndroidManifest.xml, set the theme of your {@code FlutterFragmentActivity} to
   *   your launch theme.
   *   <li>Add a {@code <meta-data>} property to your {@code FlutterFragmentActivity} with a name
  ...
  private void switchLaunchThemeForNormalTheme() {
    try {
      ...
      if (activityInfo.metaData != null) {
        int normalThemeRID = activityInfo.metaData.getInt(FlutterActivityLaunchConfigs.NORMAL_THEME_META_DATA_KEY, -1);
        if (normalThemeRID != -1) {
  ...
  private Drawable getSplashScreenFromManifest() {
    try {
      ...
      Integer splashScreenId = metadata != null ? metadata.getInt(FlutterActivityLaunchConfigs.SPLASH_SCREEN_META_DATA_KEY) : null;
   ...
   * bar, if this {@code Activity}'s desired {@link FlutterActivityLaunchConfigs.BackgroundMode} is {@link FlutterActivityLaunchConfigs.BackgroundMode#transparent}.
   * <p>
  ...
  protected FlutterFragment createFlutterFragment() {
    FlutterActivityLaunchConfigs.BackgroundMode backgroundMode = getBackgroundMode();
    FlutterView.RenderMode renderMode = backgroundMode == FlutterActivityLaunchConfigs.BackgroundMode.opaque
        ? FlutterView.RenderMode.surface
        : FlutterView.RenderMode.texture;
    FlutterView.TransparencyMode transparencyMode = backgroundMode == FlutterActivityLaunchConfigs.BackgroundMode.opaque
  ...
  public String getDartEntrypointFunctionName() {
    try {
      ...
      Bundle metadata = activityInfo.metaData;
      String desiredDartEntrypoint = metadata != null ? metadata.getString(FlutterActivityLaunchConfigs.DART_ENTRYPOINT_META_DATA_KEY) : null;
      return desiredDartEntrypoint != null ? desiredDartEntrypoint : FlutterActivityLaunchConfigs.DEFAULT_DART_ENTRYPOINT;
    } catch (PackageManager.NameNotFoundException e) {
  ...
  protected String getInitialRoute() {
    ...
    try {
      ...
      Bundle metadata = activityInfo.metaData;
      String desiredInitialRoute = metadata != null ? metadata.getString(FlutterActivityLaunchConfigs.INITIAL_ROUTE_META_DATA_KEY) : null;
      return desiredInitialRoute != null ? desiredInitialRoute : FlutterActivityLaunchConfigs.DEFAULT_INITIAL_ROUTE;
    } catch (PackageManager.NameNotFoundException e) {
  ...
  protected String getCachedEngineId() {
    return getIntent().getStringExtra(FlutterActivityLaunchConfigs.EXTRA_CACHED_ENGINE_ID);
  }

  /**
   * The desired window background mode of this {@code Activity}, which defaults to
   * {@link FlutterActivityLaunchConfigs.BackgroundMode#opaque}.
   */
  @NonNull
