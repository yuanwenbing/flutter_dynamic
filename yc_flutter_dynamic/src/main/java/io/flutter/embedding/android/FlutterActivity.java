 ...
 * {@link FlutterEngineCache} is the cache that is used to obtain a
...
public class FlutterActivity extends Activity
  ...
  private Drawable getSplashScreenFromManifest() {
    try {
      ...
      int splashScreenId = metadata != null ? metadata.getInt(FlutterActivityLaunchConfigs.SPLASH_SCREEN_META_DATA_KEY) : 0;
  ...
  public boolean shouldDestroyEngineWithHost() {
    boolean explicitDestructionRequested = getIntent().getBooleanExtra(FlutterActivityLaunchConfigs.EXTRA_DESTROY_ENGINE_WITH_ACTIVITY, false);
    if (getCachedEngineId() != null || delegate.isFlutterEngineFromHost()) {
      ...
      return getIntent().getBooleanExtra(FlutterActivityLaunchConfigs.EXTRA_DESTROY_ENGINE_WITH_ACTIVITY, true);
    }
  }
